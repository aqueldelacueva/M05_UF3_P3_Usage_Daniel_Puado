...
namespace M05_UF3_P3_Frogger
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            lanes.Add(new Lane(1, true, ConsoleColor.Blue, false, true, 0.8f, Utils.charLogs, new List<ConsoleColor>(Utils.colorsLogs)));
            lanes.Add(new Lane(2, true, ConsoleColor.Blue, false, true, 0.8f, Utils.charLogs, new List<ConsoleColor>(Utils.colorsLogs)));
            lanes.Add(new Lane(3, true, ConsoleColor.Blue, false, true, 0.8f, Utils.charLogs, new List<ConsoleColor>(Utils.colorsLogs)));
            lanes.Add(new Lane(4, true, ConsoleColor.Blue, false, true, 0.8f, Utils.charLogs, new List<ConsoleColor>(Utils.colorsLogs)));
            ...
            lanes.Add(new Lane(10, false, ConsoleColor.Black, true, false, 0.1f, Utils.charCars, new List<ConsoleColor>(Utils.colorsCars)));
